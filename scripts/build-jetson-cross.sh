...
ENABLE_AIRPLAY_H264_DEBUG_DUMP="${ENABLE_AIRPLAY_H264_DEBUG_DUMP:-OFF}"
...
cmake \
    ...
    -DJON_ENABLE_AIRPLAY_H264_DEBUG_DUMP="${ENABLE_AIRPLAY_H264_DEBUG_DUMP}" \
...
echo "[INFO] AirPlay H264 debug dump: ${ENABLE_AIRPLAY_H264_DEBUG_DUMP}"
...
docker "${DOCKER_ARGS[@]}" /bin/bash -lc \
    "export BUILD_DIR_NAME='${BUILD_DIR_NAME}'; export ENABLE_TENSORRT_MASK='${ENABLE_TENSORRT_MASK}'; export ENABLE_DRM_DISPLAY='${ENABLE_DRM_DISPLAY}'; export ENABLE_AIRPLAY_H264_DEBUG_DUMP='${ENABLE_AIRPLAY_H264_DEBUG_DUMP}'; export INSTALL_WPE_DEV='${INSTALL_WPE_DEV}'; export BUILD_HOST_NAME='${BUILD_HOST_NAME}'; export JETSON_SYSROOT_IN_CONTAINER='${CONTAINER_SYSROOT}'; export HOST_UID='${HOST_UID}'; export HOST_GID='${HOST_GID}'; ${CONTAINER_COMMAND}"
